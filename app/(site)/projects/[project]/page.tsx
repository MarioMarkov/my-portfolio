...
export default async function Project({ params }: Props) {
  ...
  return <div>
    <header className="flex items-center justify-between  ">
      <h1 className="p-3 bg-gradient-to-r from-orange-400 via-red-500 to-purple-600 bg-clip-text text-transparent text-5xl drop-shadow font-extrabold">{project.name}</h1>
    ...
    <div  className=" prose lg:prose-xl text-lg text-gray-700 mt-5">
